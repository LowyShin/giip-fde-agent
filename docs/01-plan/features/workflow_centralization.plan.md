...
## Goal
Centralize the management and documentation of custom workflows in `docs/01-plan/features/CUSTOM_WORKFLOWS.md` and automate its updates.
...
1. **Central Registry**: Create `docs/01-plan/features/CUSTOM_WORKFLOWS.md`.
